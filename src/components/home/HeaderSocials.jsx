...
const HeaderSocials = () => {
    return (
        <div className='home__socials'>
            <a href='https://github.com/tejasviurka' className='home__social-link' target='_blank' rel='noreferrer'>
                <FaGithub />
            </a>
            ...
            <a href='https://www.linkedin.com/in/tejasvi-urkande/' className='home__social-link' target='_blank' rel='noreferrer'>
                <FaLinkedinIn />
            </a>
