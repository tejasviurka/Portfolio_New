	...
	return (
		<section className="portfolio container section" id="portfolio">
			...
			<div className="portfolio__filters">
				...
				<span className={activeFilter === 2 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Java"); setActiveFilter(2) }}>
					Java
				</span>
				<span className={activeFilter === 3 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Firebase"); setActiveFilter(3) }}>
					Firebase
				</span>
				...
				<span className={activeFilter === 4 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Full Stack"); setActiveFilter(4) }}>
				Full Stack
				</span>
			</div>
